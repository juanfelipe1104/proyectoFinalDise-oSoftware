...
public class LandOfDragonsInfernalExecutioner extends Enemy implements InfernalExecutioner
{
	...
	{
		this(LandOfDragonsInfernalExecutioner.DEFAULT_STATS);
	}
	...
	public void increaseStats() 
	{
		...
		{
			super.characterStats.setStrength(((int)(super.characterStats.getStrength()*LandOfDragonsInfernalExecutioner.INCREASE_STATS)));
		}
